...
public class EstoqReserEnd implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private EstoqReserEndKey id = new EstoqReserEndKey();
	...
	public EstoqReserEnd() { }
	
	public EstoqReserEndKey getId() {
		return id;
	}
	public void setId(EstoqReserEndKey id) {
		this.id = id;
	}
