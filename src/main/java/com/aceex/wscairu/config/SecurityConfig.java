...
import com.aceex.wscairu.security.JWTAuthenticationFilter;
import com.aceex.wscairu.security.JWTAuthorizationFilter;
import com.aceex.wscairu.security.JWTUtil;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		//registro do filtro de autorização dois end points
